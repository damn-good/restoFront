            ...
            <div class="row">
                <!-- Begin Content -->
                            ...
                            <div class="col-md-8" >
                                ...
                                <!-- General Unify Forms -->
                                <g:uploadForm resource="${this.restoMenuElement}" method="POST" class="sky-form">
                                <f:with bean="restoMenuElement">
                                    <header style="text-align: center;">Formulaire d'ajout de produit</header>
                                    ...
                                    <fieldset>
                                        ...
                                        <section>
                                            <label class="input-file" for="photo" style="font-weight: 700">
                                                <f:field  type="file" label="Image" property="photo"/>
                                            </label>
                                        </section>                                       
                                            <label class="input">
                                        ...
                                        <section>
                                            ...
                                            <label class="select">
                                                <f:field property="category" label="Catégorie"/>
                                            </label>
                                        </section> 
                                        ...
                                        <section>
                                            ...
                                            <label class="input">
                                                <f:field property="cookDuration" label="Durée de préparation"/>
                                            </label>
                                        </section> 
                                        
                                        <button type="submit" class="btn-u">Valider</button>
                                         <button type="button" class="btn-u btn-u-default" onclick="window.history.back();">Retour</button>                                    
