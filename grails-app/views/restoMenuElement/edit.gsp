    ...
    <div class="shop-product">
        ...
        <div class="container">
            <ul class="breadcrumb-v5">
                ...
                <li class="active"><a href="#" class="active">Modification de produit</a></li>
            </ul>
        </div>
        <!-- End Breadcrumbs v5 -->
                ...
                <div class="col-md-6 md-margin-bottom-50">
                    <div class="ms-showcase2-template" >
                        <!-- Master Slider -->
                            ...
                            <img style="width:500px" class="ms-brd" src="/file/getMenuElementPhoto/${restoMenuElement.id}" alt="lorem ipsum dolor sit"/>
