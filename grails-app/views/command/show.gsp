...
<html>
    ...
    <body>
        ...
        <div id="show-command" class="content scaffold-show" role="main">
            ...
            <f:display bean="command" />
            <g:form resource="${this.command}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.command}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
